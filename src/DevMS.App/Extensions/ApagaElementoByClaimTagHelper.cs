...
namespace DevMS.App.Extensions
{
    ...
    [HtmlTargetElement("a", Attributes = "disable-by-claim-type")]
    public class BloqueiaLinkByClaimTagHelper : TagHelper
    {
        private readonly IHttpContextAccessor _contextAccessor;

        public BloqueiaLinkByClaimTagHelper(IHttpContextAccessor contextAccessor)
        {
            _contextAccessor = contextAccessor;
        }
